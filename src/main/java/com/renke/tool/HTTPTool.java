...
public class HTTPTool {
	 ...
	 * 接口调用 DELETE
	 */
	public static void httpURLConectionDEL(String urlPath) {
		try {
	 ...
	 * 接口调用 GET
	 */
	public static void httpURLConectionGET(String urlPath) {
		try {
			URL url = new URL(urlPath);    // 把字符串转换为URL请求地址
			HttpURLConnection connection = (HttpURLConnection) url.openConnection();// 打开连接
			connection.connect();// 连接会话
	 ...
	 * 接口调用  POST
	 */
	public static void httpURLConnectionPOST(String urlPath) {
		try {
